...
def weight_ngram_score(ngram, text, article_dict, ngram_abs_count, corr_dict=None, score_func='weight_both_ngram4'):
    nb = NgramBindings(ngram, text, corr_dict=corr_dict)
...
class NgramBindings(object):
    ...
    def __init__(self, ngram, stemmed_text, corr_dict=None):
        self.values_dict = {}
